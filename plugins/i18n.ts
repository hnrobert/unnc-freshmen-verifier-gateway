...
const dashboardMessages: Record<Locale, Record<string, unknown>> = {
  zh: {
    editor: {
      ...
      reminders: '到期提醒',
      remindersHint: '在所选时间（中午 12:00）向已开启提醒的成员发送邮件',
      reminder3d: '过期前 3 天',
      reminder2d: '过期前 2 天',
      reminder1d: '过期前 1 天',
      reminderDayOf: '当天 12:00',
  ...
  en: {
    editor: {
      ...
      remindersHint: 'Email opted-in members at the selected times (12:00 local)',
      reminder3d: '3 days before',
      reminder2d: '2 days before',
      reminder1d: '1 day before',
      reminderDayOf: 'On the day, 12:00',
