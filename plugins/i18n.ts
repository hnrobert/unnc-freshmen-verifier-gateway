...
const dashboardMessages: Record<Locale, Record<string, unknown>> = {
  zh: {
    ...
    home: {
      ...
      navSource: '源码',
      badge: '为 UNNC 学生组织打造',
      title: '让新生验证，简单、可信、即时',
      subtitle:
        '为每一个学生组织生成专属的验证页面——服务端直连 UNNC 招生门户，自动完成滑块验证，秒级确认录取状态，并自动生成欢迎页与到期提醒。',
      cta: '进入控制台',
      secondary: '查看源码',
      featuresTitle: '一个平台，覆盖验证的全流程',
      featuresSubtitle: '从门户核验到欢迎页、协作、分析与提醒，开箱即用。',
      f1Title: '实时门户验证',
      f1Desc: '服务端直连 UNNC 招生门户，自动求解滑块验证码，秒级返回录取状态。',
      f2Title: '每个组织，专属页面',
  ...
  en: {
    ...
    home: {
      ...
      title: 'Freshman verification, made simple and instant',
      subtitle:
        'A dedicated verification page for every student org — server-side checks against the live UNNC admission portal, slider captcha solved automatically, admission confirmed in seconds, with auto-generated welcome pages and expiry reminders.',
      cta: 'Go to dashboard',
      ...
      f1Desc:
        'Server-side checks against the live UNNC admission portal — the slider captcha is solved automatically and admission status returns in seconds.',
