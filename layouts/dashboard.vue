  ...
  <div class="flex min-h-screen bg-background">
    ...
    >
      ...
      <nav class="flex-1 space-y-1 p-3">
        ...
        <NuxtLink
          ...
          to="/dashboard/admin"
          class="flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium transition-colors"
          :class="route.path === '/dashboard/admin' ? 'bg-primary text-primary-foreground' : 'text-muted-foreground hover:bg-accent hover:text-foreground'"
        >
      ...
      <div class="border-t p-3">
        ...
        <button
          class="flex w-full items-center gap-3 rounded-lg px-3 py-2 text-sm text-muted-foreground transition-colors hover:bg-accent hover:text-foreground"
          @click="logout"
        >
    ...
    <div class="flex flex-1 flex-col lg:pl-64">
      ...
      <header class="sticky top-0 z-20 flex h-14 items-center gap-3 border-b bg-background/95 px-4 backdrop-blur lg:hidden">
        <button
          class="flex size-8 items-center justify-center rounded-lg border"
