import { getPageBySlug } from '#server/utils/pages'
 ...
 *
 * The welcome image ref is left unresolved in loadPageConfig (kept as
...
export default defineEventHandler(async (event) => {
  ...
  const image = await resolveImgRef(raw, page.id)
